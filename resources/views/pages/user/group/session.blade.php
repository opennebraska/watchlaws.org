...
@section('html_title', implode(' | ', [$session->short_description, $state->name, $topic->name, $workspace->name, $root->name]))
@push('body')
    <x-container>
        ...
        <nav class="mb-6">
            <a href="{{ route('group.session.show', [$topic, $state->abbreviation, $session]) }}">bookmarks</a>
